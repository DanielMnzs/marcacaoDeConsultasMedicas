...
// 🔥 MUDANÇA: Importei o 'Button' que estava faltando na declaração original
...
interface UserManagementProps {
  style?: ViewStyle;
  onSignOut?: () => Promise<void>; // ⬅️ A função que o AdminDashboard passa
}
...
const UserManagement: React.FC<UserManagementProps> = ({
  ...
  return (
    <Container style={style}>
      ...
      {/* 🔥 MUDANÇA: Adicionamos o botão de Sair aqui */}
      {/* Ele só aparece se a função onSignOut foi passada */}
      {onSignOut && (
        <Button
          title="Sair da Conta"
          onPress={onSignOut}
...
const styles = {
  ...
  // 🔥 MUDANÇA: Adicionamos o estilo para o botão Sair
  logoutButton: {
    backgroundColor: theme.colors.error, // Vermelho
    borderRadius: 8,
    paddingVertical: 12,
